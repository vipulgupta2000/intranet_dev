...
<div class="logo">
 <div class="logo-name"><a href="<?php echo $this->baseurl ?>/"><?php echo $mainframe->getCfg('sitename') ;?></a></div>
</div>
<div class="top">
...
<p>&copy; 2009 <a href="index.php"><?php echo $mainframe->getCfg('sitename') ;?></a><br/>
...
<div class="cleared"></div>
<p class="page-footer"><?php include "templates.php"; ?></p>
